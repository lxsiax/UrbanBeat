...
export default function Create({ todaslasTallas }: Props) {
    ...
    const validarFormulario = (): boolean => {
        ...
        if (!data.imagen) {
            setError('imagen', 'La imagen del producto es obligatoria.');
            valido = false;
        } else {
            ...
            <main className="flex-grow pt-40 pb-20 px-6">
                <div className="max-w-2xl mx-auto">
                    ...
                    <h1 className="text-5xl font-black italic uppercase tracking-tighter text-black mb-12">
                        Nuevo <span className="text-pink-500">Producto</span>
                    </h1>
                    ...
                    <div className="bg-white p-10 rounded-[30px] border-2 border-black shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
                        ...
                        <form onSubmit={enviar} className="space-y-6" noValidate>
                            ...
                            <div>
                                <label className="block text-[10px] font-black uppercase mb-2 tracking-widest">Subir Imagen</label>
                                <input 
                                    type="file" 
                                    accept="image/*"
                            ...
                            <div>
                                <label className="block text-[10px] font-black uppercase mb-3 tracking-widest">Añadir Stock Inicial por Tallas</label>

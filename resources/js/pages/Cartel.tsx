                                            ...
                                            {esAdmin && (
                                                <div className="absolute top-4 right-4 flex flex-col gap-3 z-30">
                                                    <button
                                                        ...
                                                        className={`p-3 rounded-xl border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all active:scale-90 active:shadow-none hover:-translate-y-1 ${artista.esta_oculto ? 'bg-black text-white' : 'bg-yellow-400 text-black'
                                                            }`}
                                                    >
